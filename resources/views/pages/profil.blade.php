...
<section class="relative bg-[#1e3a8a] text-white py-14 md:py-24 overflow-hidden">
    ...
    <div class="container relative mx-auto px-4 md:px-6 text-center z-10">
        <h1 class="text-3xl md:text-5xl font-extrabold tracking-tight text-[#f5c542]">Profil Sekolah</h1>
    ...
    <div class="container mx-auto px-4 md:px-6">
        <div class="grid gap-10 md:gap-16 md:grid-cols-2 items-center">
            <div class="relative group">
                ...
                <img src="{{ asset('images/sekolah.png') }}" alt="Aktivitas Siswa CIM" loading="lazy" class="relative rounded-2xl shadow-xl w-full h-auto object-cover">
            </div>
...
<section class="py-14 md:py-24 bg-[#1e3a8a]">
    <div class="container mx-auto px-4 md:px-6 text-center text-white">
        <h2 class="text-2xl md:text-4xl font-extrabold mb-8 md:mb-12 text-white">Keunggulan <span class="text-[#f5c542]">CIM School</span></h2>
        ...
        <div class="grid gap-4 md:gap-6 sm:grid-cols-2 md:grid-cols-3">
            ...
            @foreach ($keunggulan as $k)
                <div class="bg-white/10 backdrop-blur-md p-5 md:p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition group">
...
<section class="py-14 md:py-24 bg-gray-50">
    <div class="container mx-auto px-4 md:px-6">
        ...
        <div class="grid gap-5 md:gap-8 md:grid-cols-3">
            <div class="bg-white p-5 md:p-8 rounded-2xl shadow-sm border-l-4 border-[#f5c542] hover:shadow-lg transition">
