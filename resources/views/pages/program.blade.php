...
<section class="relative bg-[#1e3a8a] text-white py-24 overflow-hidden">
    ...
    <div class="container relative mx-auto px-6 text-center z-10">
        ...
        <h1 class="mt-4 text-4xl md:text-5xl font-extrabold tracking-tight text-white">Program Keahlian</h1>
...
<section class="py-24 bg-gray-50">
    <div class="container mx-auto px-6 space-y-16">
        ...
        @foreach ($programs as $p)
            <div class="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 grid md:grid-cols-5 items-center hover:shadow-xl transition-shadow duration-500 group">
                <div class="md:col-span-2 h-72 md:h-full overflow-hidden bg-gray-200">
                    <img src="{{ asset('images/jurusan/' . $p['img']) }}" alt="{{ $p['nama'] }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                </div>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-6">
        <div class="bg-gradient-to-r from-[#1e3a8a] to-[#3b1d6b] rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
            ...
            <h2 class="text-3xl md:text-4xl font-bold mb-6">Tentukan Masa Depanmu Sekarang</h2>
            <p class="text-gray-300 max-w-2xl mx-auto mb-10 text-lg">Jangan lewatkan kesempatan bergabung dengan SMK Inspiratif Terbaik Nasional 2023. Kuota terbatas untuk setiap jurusan!</p>
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('ppdb') }}" class="bg-[#f5c542] text-[#1e3a8a] font-black px-10 py-4 rounded-full shadow-lg hover:scale-105 transition transform text-lg">
                    Daftar Sekarang
                </a>
                <a href="{{ route('kontak') }}" class="border-2 border-white text-white font-bold px-10 py-4 rounded-full hover:bg-white hover:text-[#1e3a8a] transition text-lg">
                    Konsultasi Jurusan
                </a>
            </div>
        </div>
